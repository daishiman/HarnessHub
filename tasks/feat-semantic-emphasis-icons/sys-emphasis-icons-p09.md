---
graph_node_id: "SYS-EMPHASIS-ICONS-P09"
artifact_kind: "task"
artifact_subtypes: []
...
target_date: null
iteration: null
title: "品質保証 — CI 品質ゲート (絵文字 lint fail-closed/axe/コントラスト/VRT) の確認"
owners: ["daishiman"]
created_at: "2026-08-13T23:31:45Z"
updated_at: "2026-08-14T11:12:08Z"
status: "closed"
depends_on: ["SYS-EMPHASIS-ICONS-P08"]
related_nodes: ["feat-semantic-emphasis-icons","arch-harness-hub-design-system","arch-harness-hub-frontend"]
resource_scope: ["docs/features/feat-semantic-emphasis-icons/quality-gate-report.md"]
purpose: "絵文字 lint の CI 上での fail-closed 動作、callout の a11y、ライトモード背景のコントラスト・VRT 相当の品質ゲートが機能していることを確認する。"
goal: "content-addressed published task spec の全責務・受入条件・検証・rollback を満たし、再実行可能な証跡を残す"
scope_in: ["docs/features/feat-semantic-emphasis-icons/quality-gate-report.md"]
scope_out: ["配色仕様書 v2 そのものの改訂 (architecture/harness-hub-design-system.md の所有)","各画面の情報構造・機能追加 (feat-card-list-shell の担当)","Markdown のカードブロック記法 (feat-card-block-authoring の担当)","公開 API・DB schema・認可判定・Cloudflare deploy unit の変更","実装コードの修正 (未充足ゲートがある場合は P05/P06 へ差し戻す)"]
acceptance: ["絵文字 lint が CI 上で fail-closed に機能していること (lint step 自体が skip/失敗した場合も CI 全体が失敗すること) が quality-gate-report.md に記録されている","callout の a11y (axe 等) とライトモード背景のコントラスト・VRT (Visual Regression Test) 相当の確認結果が記録されている","quality_constraints 5 件それぞれについて CI 品質ゲートでの充足確認結果が記録されている"]
...
phase_ref: "P09"
file_path: "tasks/feat-semantic-emphasis-icons/sys-emphasis-icons-p09.md"
template_id: "task"
...
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-semantic-emphasis-icons/sys-emphasis-icons-p09.md","confidence":0.9}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"HarnessHub-xo7n.9","linked_at":"2026-08-14T03:40:00Z","sync_state":"linked"}
...
# 品質保証 — CI 品質ゲート (絵文字 lint fail-closed/axe/コントラスト/VRT) の確認

> task projection (P09 / parent: feat-semantic-emphasis-icons)。実装要件の正本は下記の content-addressed published task spec であり、このファイルは実行入口だけを保持する。
...
- task spec: `.dev-graph/plans/generations/feature-package-feat-semantic-emphasis-icons/b10daedf4d24a112c73943e2cecac213a193042aaa0e6e43518a2314a64cfbdf/task-specs/phase-09-quality-assurance.md`
- package digest: `sha256:b10daedf4d24a112c73943e2cecac213a193042aaa0e6e43518a2314a64cfbdf`
- task spec SHA-256: `sha256:71d446e4f479159e5c355839b7b72653ec76e497f2e561ce86587e5d4569e0e0`
