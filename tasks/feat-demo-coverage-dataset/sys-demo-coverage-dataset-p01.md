...
target_date: null
iteration: null
title: "確認用データセット要件ベースライン確定 — 28 route × 5 状態 × enum 全値の対応表確定"
owners: ["daishiman"]
created_at: "2026-08-14T13:38:08Z"
updated_at: "2026-08-14T23:12:26.561866Z"
status: "done"
depends_on: []
related_nodes: ["feat-demo-coverage-dataset","arch-harness-hub-data","arch-harness-hub-testing-qa"]
resource_scope: ["docs/features/feat-demo-coverage-dataset/requirements-baseline.md"]
purpose: "feat-demo-coverage-dataset の P01 を実行する: 確認用データセット要件ベースライン確定 — 28 route × 5 状態 × enum 全値の対応表確定"
goal: "content-addressed published task spec の全責務・受入条件・検証・rollbackを満たし、再実行可能な証跡を残す"
scope_in: ["docs/features/feat-demo-coverage-dataset/requirements-baseline.md"]
scope_out: ["published task spec の『スコープ外』節を正本とする"]
acceptance: ["docs/features/feat-demo-coverage-dataset/requirements-baseline.md に goal-spec acceptance 7 件と scope_in 8 件・scope_out 5 件が過不足なく転記され、対象 28 route の一覧と route×状態(空/1件/大量/長文/エラー)対応表の骨子が明記されている"]
...
phase_ref: "P01"
file_path: "tasks/feat-demo-coverage-dataset/sys-demo-coverage-dataset-p01.md"
template_id: "task"
...
classification_reason: "goal-spec (goal-spec.json) と features/feat-demo-coverage-dataset.md の purpose/goal/scope_in 8 件/scope_out 5 件/acceptance 7 件を要件ベースラインへ確定転記する P01 タスク"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-demo-coverage-dataset/sys-demo-coverage-dataset-p01.md","confidence":0.9}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"HarnessHub-imlj","linked_at":"2026-08-14T15:00:16Z","sync_state":"linked"}
github_publication: {"labels":[],"milestone":null,"mode":"local_only","project_aliases":[]}
github_project_linkages: []
pull_request_linkages: []
execution_contexts: []
completion_evidence: {"completed_at":"2026-08-14T23:12:04Z","evidence_refs":["docs/features/feat-demo-coverage-dataset/requirements-baseline.md","tasks/feat-demo-coverage-dataset/sys-demo-coverage-dataset-p01.md"],"policy":"manual","reconciled_at":"2026-08-14T23:15:00Z","source":"manual","status":"done"}
implementation_readiness: {"checked_at":"2026-08-14T13:10:00Z","missing_sections":[],"status":"complete"}
---

# 確認用データセット要件ベースライン確定 — 28 route × 5 状態 × enum 全値の対応表確定

> task projection (P01 / parent: feat-demo-coverage-dataset)。実装要件の正本は下記の content-addressed published task spec であり、このファイルは実行入口だけを保持する。
...
- task spec: `.dev-graph/plans/generations/feature-package-feat-demo-coverage-dataset/a43737a6471ef2ebe1f2a77ef21fe644ee6a28a39f8ddc13edefaff0f197c577/task-specs/phase-01-requirements.md`
- package digest: `sha256:a43737a6471ef2ebe1f2a77ef21fe644ee6a28a39f8ddc13edefaff0f197c577`
- task spec SHA-256: `sha256:a623d0315ba068f686144e29dac98b367cefa33c3a027c02c88bac192b622932`
