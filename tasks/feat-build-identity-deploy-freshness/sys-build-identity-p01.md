---
graph_node_id: "SYS-BUILD-IDENTITY-P01"
artifact_kind: "task"
artifact_subtypes: []
...
target_date: null
iteration: null
title: "要件ベースライン確定 — 稼働ビルドの素性確認 (V6) と deploy 反映鮮度検出 (V7) の要件確定"
owners: ["daishiman"]
created_at: "2026-08-07T12:10:05Z"
updated_at: "2026-08-07T14:10:05.189200Z"
status: "active"
depends_on: []
related_nodes: ["feat-build-identity-deploy-freshness","arch-harness-hub-infrastructure","arch-harness-hub-testing-qa"]
resource_scope: ["docs/features/feat-build-identity-deploy-freshness/requirements-baseline.md"]
purpose: "feat-build-identity-deploy-freshness の P01 を実行する: 要件ベースライン確定 — 稼働ビルドの素性確認 (V6) と deploy 反映鮮度検出 (V7) の要件確定"
goal: "content-addressed published task spec の全責務・受入条件・検証・rollback を満たし、再実行可能な証跡を残す"
scope_in: ["docs/features/feat-build-identity-deploy-freshness/requirements-baseline.md"]
...
acceptance: ["docs/features/feat-build-identity-deploy-freshness/requirements-baseline.md に goal-spec.json の purpose/goal/scope_in 4 件/scope_out 3 件/acceptance 5 件が逐語一致で転記されている","露出してよい情報の範囲 (commit 識別子まで) と、露出してはならないもの (内部 path・secret・個人データ) が明示されている","鮮度検出が『古いこと』ではなく『古い状態が継続していること』を見る要件であることが、実測 (2026-08-03 の修正が 2026-08-07 時点で未反映 = 4 日継続) を根拠に記述されている"]
...
phase_ref: "P01"
file_path: "tasks/feat-build-identity-deploy-freshness/sys-build-identity-p01.md"
template_id: "task"
...
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-build-identity-deploy-freshness/sys-build-identity-p01.md","confidence":0.92}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"HarnessHub-7sac","linked_at":"2026-08-07T13:44:19Z","sync_state":"linked"}
...
# 要件ベースライン確定 — 稼働ビルドの素性確認 (V6) と deploy 反映鮮度検出 (V7) の要件確定

> task projection (P01 / parent: feat-build-identity-deploy-freshness)。実装要件の正本は下記の content-addressed published task spec であり、このファイルは実行入口だけを保持する。
...
- task spec: `.dev-graph/plans/generations/feature-package-feat-build-identity-deploy-freshness/9a7908d1a6d1c1c92220f062e79a58c943a6dd02705ecb3302703a2b9e07a2a9/task-specs/phase-01-requirements.md`
- package digest: `sha256:9a7908d1a6d1c1c92220f062e79a58c943a6dd02705ecb3302703a2b9e07a2a9`
- task spec SHA-256: `sha256:f226c597bdbcf9a33c2c51cd54dfd65a5cc5f1076fa85e3e2b967969ff7d3f68`
