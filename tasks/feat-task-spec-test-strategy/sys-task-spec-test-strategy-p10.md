...
classification_reason: "system-spec/testing-qa.md qa-070/qa-072/qa-073/qa-074 のタスク仕様書テスト戦略必須化要求のうち P10 責務 (最終レビュー — 全 phase 成果の横断整合確認) を実行する task"
...
- parent_feature: feat-task-spec-test-strategy
- phase_ref: P10
- classification: confidence=0.86, reason="system-spec/testing-qa.md qa-070/qa-072/qa-073/qa-074 のタスク仕様書テスト戦略必須化要求のうち P10 責務 (最終レビュー — 全 phase 成果の横断整合確認) を実行する task", candidates=[{artifact_kind: task, confidence: 0.86, candidate_path: tasks/feat-task-spec-test-strategy/sys-task-spec-test-strategy-p10.md}]
...
各 phase は独立した責務を個別に遂行するため、phase 間で前提や用語の解釈にずれが生じるリスクがある。qa-070/qa-072/qa-073/qa-074 が要求する品質基準の一貫性を担保するため、証跡固定 (P11) とリリース (P13) の前に、全 phase 成果を横断で照合するレビューを設ける。
