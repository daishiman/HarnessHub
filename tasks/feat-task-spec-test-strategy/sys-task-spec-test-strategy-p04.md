---
graph_node_id: "SYS-TASK-SPEC-TEST-STRATEGY-P04"
artifact_kind: "task"
artifact_subtypes: []
...
target_date: null
iteration: null
title: "テスト設計 — section 欠落拒否・完備 PASS・再生成冪等・exact-13 非退行の回帰テスト設計"
owners: ["daishiman"]
created_at: "2026-07-24T23:09:08Z"
updated_at: "2026-07-28T04:12:29Z"
status: "closed"
depends_on: ["SYS-TASK-SPEC-TEST-STRATEGY-P03"]
related_nodes: ["feat-task-spec-test-strategy","arch-harness-hub-testing-qa"]
resource_scope: ["docs/features/feat-task-spec-test-strategy/test-plan.md"]
purpose: "acceptance 7 件それぞれを実行可能な test ID へ写像し、section 欠落拒否・4 項目完備 PASS・再生成冪等・テストレベル/層別方針導出・カバレッジ 80% 表現・保守性制約明記・exact-13 非退行という 7 観点の回帰テストを test-plan.md として設計する。P05 はこの test ID の実装対象を実装し、P06 が実行する。"
goal: "P04 の受入条件と品質ゲートを満たし、再実行可能な検証証跡を残す"
scope_in: ["docs/features/feat-task-spec-test-strategy/test-plan.md"]
...
phase_ref: "P04"
file_path: "tasks/feat-task-spec-test-strategy/sys-task-spec-test-strategy-p04.md"
template_id: "task"
...
beads_linkage: {"bd_issue_id":"HarnessHub-a4ks.4","linked_at":"2026-07-25T00:00:00Z","sync_state":"linked"}
github_publication: {"labels":[],"milestone":null,"mode":"local_only","project_aliases":[]}
github_project_linkages: []
pull_request_linkages: []
execution_contexts: []
completion_evidence: {"completed_at":"2026-07-25T14:18:23Z","evidence_refs":["issues/sys-lint-open-residue-ci-red-20260725.md"],"policy":"manual","reconciled_at":"2026-07-26T01:19:20.811908Z","source":"reconciliation","status":"done"}
...
- `SYS-TASK-SPEC-TEST-STRATEGY-P03`
