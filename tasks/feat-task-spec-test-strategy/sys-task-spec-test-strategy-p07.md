...
updated_at: "2026-07-25T00:49:45.743677Z"
status: "active"
...
classification_reason: "system-spec/testing-qa.md qa-070/qa-072/qa-073/qa-074 のタスク仕様書テスト戦略必須化要求のうち P07 責務 (受入判定 — goal-spec acceptance 7 件の突合と未達の差し戻し) を実行する task"
...
- parent_feature: feat-task-spec-test-strategy
- phase_ref: P07
- classification: confidence=0.86, reason="system-spec/testing-qa.md qa-070/qa-072/qa-073/qa-074 のタスク仕様書テスト戦略必須化要求のうち P07 責務 (受入判定 — goal-spec acceptance 7 件の突合と未達の差し戻し) を実行する task", candidates=[{artifact_kind: task, confidence: 0.86, candidate_path: tasks/feat-task-spec-test-strategy/sys-task-spec-test-strategy-p07.md}]
...
P07/P10 は実行された証跡だけを判定対象とする (P04 test-plan の trace rule)。acceptance 突合を目視確認ではなく、実行済み evidence に基づく機械可読な判定として固定することで、qa-070/qa-072/qa-073/qa-074 が要求する品質基準の冪等な再現性を担保する。
