...
classification_reason: "system-spec/testing-qa.md qa-076/qa-078/qa-079/qa-080 のタスク仕様書テスト戦略必須化要求のうち P13 責務 (リリース — main 反映と確定 system spec/architecture への writeback) を実行する task"
...
execution_contexts: []
completion_evidence: {"completed_at":"2026-07-26T00:29:01Z","evidence_refs":["issues/sys-lint-open-residue-ci-red-20260725.md"],"policy":"manual","reconciled_at":"2026-07-26T01:19:20.811908Z","source":"reconciliation","status":"done"}
...
goal-spec の到達状態 (task spec がテスト戦略 4 項目を必須 section として持ち、欠落した仕様書は promotion 前に fail-closed で拒否され、同一入力の再生成で section 構成が冪等に一致する) を確定させ、qa-076/qa-078/qa-079/qa-080 の解決を system-spec 側へ反映する最終 phase。
...
- 仕様正本: system-spec/testing-qa.md qa-076/qa-078/qa-079/qa-080/qa-134 (テスト戦略必須化と世代非依存 rerun command)
