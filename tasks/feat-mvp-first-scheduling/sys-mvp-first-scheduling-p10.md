---
graph_node_id: "SYS-MVP-FIRST-SCHEDULING-P10"
artifact_kind: "task"
artifact_subtypes: []
...
updated_at: "2026-07-23T14:14:51Z"
status: "closed"
depends_on: ["SYS-MVP-FIRST-SCHEDULING-P09"]
related_nodes: ["feat-mvp-first-scheduling","arch-harness-hub-dev-workflow"]
resource_scope: ["docs/features/feat-mvp-first-scheduling/final-review.md"]
purpose: "P01 から P09 までの全成果物が goal-spec と矛盾なく整合していることを横断的に確認する。"
goal: "P10 の受入条件と品質ゲートを満たし、再実行可能な検証証跡を残す"
scope_in: ["docs/features/feat-mvp-first-scheduling/final-review.md"]
...
phase_ref: "P10"
file_path: "tasks/feat-mvp-first-scheduling/sys-mvp-first-scheduling-p10.md"
template_id: "task"
...
source_lineage: {"imported_at":"2026-07-23T07:08:08Z","origin_kind":"system-dev-planner","source_digest":"55a34fe2a62841c0175b568204b4a1fde8e1fd04d1c0496bb4e0444e3cf86387","source_path":".dev-graph/plans/generations/feature-package-feat-mvp-first-scheduling/55a34fe2a62841c0175b568204b4a1fde8e1fd04d1c0496bb4e0444e3cf86387/task-specs/phase-10-final-review.md","source_plugin":"system-dev-planner","source_version":"0.1.0"}
classification_confidence: 0.87
classification_reason: "qa-069 の MVP ファースト化要求のうち P10 責務 (最終レビュー — 全 phase 成果の横断整合確認) を実行する task"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-mvp-first-scheduling/sys-mvp-first-scheduling-p10.md","confidence":0.87}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"HarnessHub-6gl.10","linked_at":"2026-07-23T08:22:25Z","sync_state":"linked"}
github_publication: {"labels":[],"milestone":null,"mode":"local_only","project_aliases":[]}
github_project_linkages: []
pull_request_linkages: []
execution_contexts: [{"base_branch":"main","branch":"devgraph/SYS-MVP-FIRST-SCHEDULING-P10","head_sha":"6ab7d593967b2f93ed1c2a5f069719bfe032c71f","last_seen_at":"2026-07-23T14:12:56.192253Z","lease_acquired_at":"2026-07-23T14:12:54.316309Z","released_at":null,"state":"claimed","worktree_id":"wt_f5b59c7488943714"}]
...
- parent_feature: feat-mvp-first-scheduling
- phase_ref: P10
- classification: confidence=0.87, reason="qa-069 の MVP ファースト化要求のうち P10 責務 (最終レビュー — 全 phase 成果の横断整合確認) を実行する task", candidates=[{artifact_kind: task, confidence: 0.87, candidate_path: tasks/feat-mvp-first-scheduling/sys-mvp-first-scheduling-p10.md}]
...
P01 から P09 までの全成果物が goal-spec と矛盾なく整合していることを横断的に確認する。

## 背景

P07 は acceptance 突合、P10 は phase 間の整合 (metadata 設計と実装の一致・テスト ID とテスト実行の一致など) を検証する別軸のレビューである。

## 前提条件

- P01 upstream entry gate: N/A: intra-feature depends_on gate
- Required predecessor: SYS-MVP-FIRST-SCHEDULING-P09 が done であること
...
- Backend: N/A: 本 phase は最終レビューのみで実装コードを変更しない
...
- Quality: applicable + change: P01..P09 成果物の横断整合を検証する
- Documentation: applicable + change: docs/features/feat-mvp-first-scheduling/final-review.md を新規作成する
...
- Compatibility/migration/backfill: N/A: 本 phase は横断レビューのみで互換性変更を伴わない
...
- Write scope/touches: docs/features/feat-mvp-first-scheduling/final-review.md
...
- PR body contract: Closes に紐づく beads issue 番号 + dev-graph graph_node_id (sys-mvp-first-scheduling-p10) を本文に明記し、default branch を対象にする
- Ownership boundary: system-dev-planner は intent の宣言のみを行い、dev-graph が実際の binding 解決・mutation・reconciliation を行う

## Branch and worktree execution

- Branch: dev-graph 登録後に C15 が devgraph/sys-mvp-first-scheduling-p10 として払い出す。system-dev-planner は事前に branch 名を確定しない
- Worktree lease: 実装着手前に graph_node_id (sys-mvp-first-scheduling-p10) の worktree lease を claim し、heartbeat 送出と完了時 release を行う
- Parallel safety: 直前 predecessor task (SYS-MVP-FIRST-SCHEDULING-P09) が done になるまで着手しない。write scope が他 task の active lease と重複しないことを確認する
...
- Required evidence: final-review.md に P01..P09 成果物の相互整合チェック結果が記録されていること
...
- Rollout: P01..P09 の成果物を横断確認し、矛盾がなければ P11 へ引き継ぐ
- Rollback trigger and steps: phase 間の不整合が見つかった場合、不整合の原因となった phase へ差し戻す
