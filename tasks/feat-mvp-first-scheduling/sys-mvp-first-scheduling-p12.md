---
graph_node_id: "SYS-MVP-FIRST-SCHEDULING-P12"
artifact_kind: "task"
artifact_subtypes: []
...
target_date: null
iteration: null
title: "運用文書化 — MVP 適合軸設定手順と選定 receipt の運用手順"
owners: ["daishiman"]
created_at: "2026-07-23T07:08:08Z"
updated_at: "2026-07-23T20:15:44Z"
status: "closed"
depends_on: ["SYS-MVP-FIRST-SCHEDULING-P11"]
related_nodes: ["feat-mvp-first-scheduling","arch-harness-hub-dev-workflow"]
resource_scope: ["docs/features/feat-mvp-first-scheduling/operations.md"]
purpose: "MVP 適合軸 metadata の設定手順と選定 receipt の読み方を運用文書として整備し、既存 node への適用方法を明文化する。"
goal: "P12 の受入条件と品質ゲートを満たし、再実行可能な検証証跡を残す"
scope_in: ["docs/features/feat-mvp-first-scheduling/operations.md"]
...
acceptance: ["選定 receipt に 目的・背景・MVP 適合の判断根拠が記録される"]
architecture_refs: ["arch-harness-hub-dev-workflow"]
parent_feature: "feat-mvp-first-scheduling"
feature_package_id: "feature-package/feat-mvp-first-scheduling"
phase_ref: "P12"
file_path: "tasks/feat-mvp-first-scheduling/sys-mvp-first-scheduling-p12.md"
template_id: "task"
...
source_lineage: {"imported_at":"2026-07-23T07:08:08Z","origin_kind":"system-dev-planner","source_digest":"55a34fe2a62841c0175b568204b4a1fde8e1fd04d1c0496bb4e0444e3cf86387","source_path":".dev-graph/plans/generations/feature-package-feat-mvp-first-scheduling/55a34fe2a62841c0175b568204b4a1fde8e1fd04d1c0496bb4e0444e3cf86387/task-specs/phase-12-documentation-operations.md","source_plugin":"system-dev-planner","source_version":"0.1.0"}
classification_confidence: 0.87
classification_reason: "qa-069 の MVP ファースト化要求のうち P12 責務 (運用文書化 — MVP 適合軸設定手順と選定 receipt の運用手順) を実行する task"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-mvp-first-scheduling/sys-mvp-first-scheduling-p12.md","confidence":0.87}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"HarnessHub-6gl.12","linked_at":"2026-07-23T08:22:25Z","sync_state":"linked"}
github_publication: {"labels":[],"milestone":null,"mode":"local_only","project_aliases":[]}
github_project_linkages: []
pull_request_linkages: []
execution_contexts: [{"base_branch":"main","branch":"devgraph/SYS-MVP-FIRST-SCHEDULING-P12","head_sha":"6ab7d593967b2f93ed1c2a5f069719bfe032c71f","last_seen_at":"2026-07-23T14:19:38.901407Z","lease_acquired_at":"2026-07-23T14:19:37.443015Z","released_at":null,"state":"claimed","worktree_id":"wt_f5b59c7488943714"}]
completion_evidence: {"completed_at":null,"evidence_refs":[],"policy":"linked_pr_merged_all","reconciled_at":null,"source":null,"status":"in_progress"}
implementation_readiness: {"checked_at":"2026-07-23T06:00:00Z","missing_sections":[],"status":"complete"}
---

# System task overlay: 運用文書化 — MVP 適合軸設定手順と選定 receipt の運用手順
...
- parent_feature: feat-mvp-first-scheduling
- phase_ref: P12
- classification: confidence=0.87, reason="qa-069 の MVP ファースト化要求のうち P12 責務 (運用文書化 — MVP 適合軸設定手順と選定 receipt の運用手順) を実行する task", candidates=[{artifact_kind: task, confidence: 0.87, candidate_path: tasks/feat-mvp-first-scheduling/sys-mvp-first-scheduling-p12.md}]
...
MVP 適合軸 metadata の設定手順と選定 receipt の読み方を運用文書として整備し、既存 node への適用方法を明文化する。

## 背景

MVP 適合軸 metadata は既存 node に対して任意 (optional) で追加される新フィールドであり、運用担当が迷わず設定できる手順が必要。

## 前提条件

- P01 upstream entry gate: N/A: intra-feature depends_on gate
- Required predecessor: SYS-MVP-FIRST-SCHEDULING-P11 が done であること
...
- Quality: applicable + change: 運用手順に品質ゲート非退行の確認手順を含める
- Documentation: applicable + change: docs/features/feat-mvp-first-scheduling/operations.md を新規作成する
- Operations: applicable + change: MVP 適合軸 metadata の設定手順と選定 receipt の読み方を運用手順として整備する
...
- Produced artifacts:
- docs/features/feat-mvp-first-scheduling/operations.md
- Consumed artifacts:
- docs/features/feat-mvp-first-scheduling/design.md
- docs/features/feat-mvp-first-scheduling/final-review.md
- Write scope/touches: docs/features/feat-mvp-first-scheduling/operations.md
...
- PR body contract: Closes に紐づく beads issue 番号 + dev-graph graph_node_id (sys-mvp-first-scheduling-p12) を本文に明記し、default branch を対象にする
- Ownership boundary: system-dev-planner は intent の宣言のみを行い、dev-graph が実際の binding 解決・mutation・reconciliation を行う

## Branch and worktree execution

- Branch: dev-graph 登録後に C15 が devgraph/sys-mvp-first-scheduling-p12 として払い出す。system-dev-planner は事前に branch 名を確定しない
- Worktree lease: 実装着手前に graph_node_id (sys-mvp-first-scheduling-p12) の worktree lease を claim し、heartbeat 送出と完了時 release を行う
- Parallel safety: 直前 predecessor task (SYS-MVP-FIRST-SCHEDULING-P11) が done になるまで着手しない。write scope が他 task の active lease と重複しないことを確認する
...
- Required evidence: operations.md に MVP 適合軸 metadata の設定手順と選定 receipt の読み方が既存 node への適用例つきで記載されていること
...
- Rollout: operations.md を write scope の範囲で作成し、P13 のリリース判断に供する
- Rollback trigger and steps: 運用手順の不備が P13 実施時に判明した場合、operations.md を修正し本 task を再実行する
