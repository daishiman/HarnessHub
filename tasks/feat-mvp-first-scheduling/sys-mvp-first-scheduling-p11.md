---
graph_node_id: "SYS-MVP-FIRST-SCHEDULING-P11"
artifact_kind: "task"
artifact_subtypes: []
...
updated_at: "2026-07-23T14:19:15Z"
status: "closed"
depends_on: ["SYS-MVP-FIRST-SCHEDULING-P10"]
related_nodes: ["feat-mvp-first-scheduling","arch-harness-hub-dev-workflow"]
resource_scope: ["eval-log/dev-graph/mvp-first-scheduling/evidence-manifest.json"]
purpose: "P06 のテスト実行ログと P09 の悪性ケース実測ログを digest 付きの evidence manifest として固定し、再実行可能な形で保存する。"
goal: "P11 の受入条件と品質ゲートを満たし、再実行可能な検証証跡を残す"
scope_in: ["eval-log/dev-graph/mvp-first-scheduling/evidence-manifest.json"]
...
phase_ref: "P11"
file_path: "tasks/feat-mvp-first-scheduling/sys-mvp-first-scheduling-p11.md"
template_id: "task"
...
source_lineage: {"imported_at":"2026-07-23T07:08:08Z","origin_kind":"system-dev-planner","source_digest":"55a34fe2a62841c0175b568204b4a1fde8e1fd04d1c0496bb4e0444e3cf86387","source_path":".dev-graph/plans/generations/feature-package-feat-mvp-first-scheduling/55a34fe2a62841c0175b568204b4a1fde8e1fd04d1c0496bb4e0444e3cf86387/task-specs/phase-11-evidence.md","source_plugin":"system-dev-planner","source_version":"0.1.0"}
classification_confidence: 0.87
classification_reason: "qa-069 の MVP ファースト化要求のうち P11 責務 (証跡固定 — 実測ログと digest の evidence manifest 化) を実行する task"
classification_candidates: [{"artifact_kind":"task","candidate_path":"tasks/feat-mvp-first-scheduling/sys-mvp-first-scheduling-p11.md","confidence":0.87}]
issue_linkage: null
tracker_binding: "beads"
beads_linkage: {"bd_issue_id":"HarnessHub-6gl.11","linked_at":"2026-07-23T08:22:25Z","sync_state":"linked"}
github_publication: {"labels":[],"milestone":null,"mode":"local_only","project_aliases":[]}
github_project_linkages: []
pull_request_linkages: []
execution_contexts: [{"base_branch":"main","branch":"devgraph/SYS-MVP-FIRST-SCHEDULING-P11","head_sha":"6ab7d593967b2f93ed1c2a5f069719bfe032c71f","last_seen_at":"2026-07-23T14:15:18.861537Z","lease_acquired_at":"2026-07-23T14:15:17.225617Z","released_at":null,"state":"claimed","worktree_id":"wt_f5b59c7488943714"}]
...
- parent_feature: feat-mvp-first-scheduling
- phase_ref: P11
- classification: confidence=0.87, reason="qa-069 の MVP ファースト化要求のうち P11 責務 (証跡固定 — 実測ログと digest の evidence manifest 化) を実行する task", candidates=[{artifact_kind: task, confidence: 0.87, candidate_path: tasks/feat-mvp-first-scheduling/sys-mvp-first-scheduling-p11.md}]
...
P06 のテスト実行ログと P09 の悪性ケース実測ログを digest 付きの evidence manifest として固定し、再実行可能な形で保存する。

## 背景

quality_constraints (P09) と acceptance (P07) の判定根拠を後から再検証できるよう、証跡の digest immutability を担保する。

## 前提条件

- P01 upstream entry gate: N/A: intra-feature depends_on gate
- Required predecessor: SYS-MVP-FIRST-SCHEDULING-P10 が done であること
...
- Documentation: applicable + change: eval-log/dev-graph/mvp-first-scheduling/evidence-manifest.json を新規作成する
...
- Write scope/touches: eval-log/dev-graph/mvp-first-scheduling/evidence-manifest.json
...
- PR body contract: Closes に紐づく beads issue 番号 + dev-graph graph_node_id (sys-mvp-first-scheduling-p11) を本文に明記し、default branch を対象にする
- Ownership boundary: system-dev-planner は intent の宣言のみを行い、dev-graph が実際の binding 解決・mutation・reconciliation を行う

## Branch and worktree execution

- Branch: dev-graph 登録後に C15 が devgraph/sys-mvp-first-scheduling-p11 として払い出す。system-dev-planner は事前に branch 名を確定しない
- Worktree lease: 実装着手前に graph_node_id (sys-mvp-first-scheduling-p11) の worktree lease を claim し、heartbeat 送出と完了時 release を行う
- Parallel safety: 直前 predecessor task (SYS-MVP-FIRST-SCHEDULING-P10) が done になるまで着手しない。write scope が他 task の active lease と重複しないことを確認する
...
- Rollback trigger and steps: 証跡の digest 不一致が見つかった場合、対象証跡を再取得し本 task を再実行する
