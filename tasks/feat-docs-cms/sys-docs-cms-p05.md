...
scope_in: ["apps/hub/src/app/(dashboard)/docs/","apps/hub/src/app/api/v1/docs/","apps/hub/src/features/docs-cms/","apps/hub/src/features/docs-cms/ai-job-adapter/","packages/db/schema/docs-cms/","packages/schemas/docs-cms/"]
...
beads_linkage: {"bd_issue_id":"HarnessHub-9wb.5","linked_at":"2026-07-18T01:43:05Z","sync_state":"linked"}
...
> task projection (P05 / parent: feat-docs-cms)。実装要件の正本は下記の content-addressed published task spec であり、このファイルは実行入口だけを保持する。
...
- task spec: `.dev-graph/plans/generations/feature-package-feat-docs-cms/a899e69eb999800a5869499783aad943cea65d394af3e3046fd6631532cf3a85/task-specs/phase-05-implementation.md`
- package digest: `sha256:a899e69eb999800a5869499783aad943cea65d394af3e3046fd6631532cf3a85`
- task spec SHA-256: `sha256:35cc0cd96898d993637bb7bfd6b0781a5646cdeaf84cb9a990b04eab12e12e51`
...
## 実装追記 (2026-08-16 / `HarnessHub-ma7t` / `HarnessHub-iz3n`)

S15 一覧はカード既定の共通 shell へ移した。本文編集は `:::cards` と大画面 2 ペイン。
詳細は [運用](../../docs/features/feat-card-list-shell/operations.md) と
