...
resource_scope: ["docs/features/feat-docs-cms/test-run-report.md"]
source_lineage: {"imported_at": "2026-07-17T13:13:50Z", "origin_kind": "system-dev-planner", "source_digest": "e393b328fe1122ffb1616cbb39d17d15602908a597263868bd566f8a2af8da3f", "source_path": ".dev-graph/plans/feature-package-feat-docs-cms/task-specs/phase-06-test-run.md", "source_plugin": "system-dev-planner", "source_version": "0.1.0"}
start_date: null
status: active
...
goal: P04 で定義した 5 テストカテゴリ (tenant 分離・doc 編集 admin 限定・Markdown sanitize・doc 編集監査・AI キュー認可) を P05 実装に対して実行し、pass/fail 結果を記録する。
scope_in: ["docs/features/feat-docs-cms/test-run-report.md"]
scope_out: ["Markdown レンダラ/エディタ部品自体のテスト実行 (design system 共通部品。owner は feat-hub-foundation)", "AI 実行基盤のサーバ側実装のテスト (D5 で不採用)", "実装コードの修正 (fail が発生した場合の修正は P05 へ差し戻す)"]
...
> task projection (P06 / parent: feat-docs-cms)。本文の正本は published task spec であり、ここには複製しない。

## 正本仕様書

- `.dev-graph/plans/feature-package-feat-docs-cms/task-specs/phase-06-test-run.md`
...
- 完了: 正本仕様書の Verification and evidence を満たし bd close (SYS-DOCS-CMS-P06)
