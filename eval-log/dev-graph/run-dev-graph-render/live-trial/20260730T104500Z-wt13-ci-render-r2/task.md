...
被験 fixture は `/Users/dm/orca/workspaces/HarnessHub/wt-13/eval-log/dev-graph/live-trial-fixtures/wt13-ci-render-r2-20260730` にある dev-graph 初期化済みの独立 Git repository です。
...
Skill({skill: "dev-graph:run-dev-graph-render", args: "--repo-root /Users/dm/orca/workspaces/HarnessHub/wt-13/eval-log/dev-graph/live-trial-fixtures/wt13-ci-render-r2-20260730"})
...
- receipt: `/Users/dm/orca/workspaces/HarnessHub/wt-13/eval-log/dev-graph/live-trial-fixtures/wt13-ci-render-r2-20260730/system-plan/LT-FEATURE-001/dev-graph-registration-receipt.json`
...
1. `/Users/dm/orca/workspaces/HarnessHub/wt-13/eval-log/dev-graph/run-dev-graph-render/live-trial/20260730T104500Z-wt13-ci-render-r2/out/status.json` に完了マーカーを 1 ファイルだけ Write する。内容:
