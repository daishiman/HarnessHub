...
`/Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260728-082322-wt-11/eval-log/dev-graph/live-trial-fixtures/lp36-merge-none`
...
並行 live-trial 環境で shell snapshot を失った探索用 subagent が停止した事例を切り分けるため、
Task / Agent は使用せず、必要な調査は親セッション内の Read / Bash で行ってください。
scenario の引数、required observations、C02 / C11 の正規経路は変更しません。
...
python3 /Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260728-082322-wt-11/plugins/dev-graph/tests/fixtures/audit_decompose_live_trial.py snapshot \
  --repo-root /Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260728-082322-wt-11/eval-log/dev-graph/live-trial-fixtures/lp36-merge-none \
  --output /Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260728-082322-wt-11/eval-log/dev-graph/live-trial-fixtures/lp36-merge-none/eval-log/pre-state.json
```
...
Skill({skill: "dev-graph:run-dev-graph-decompose", args: "ユーザー登録とログインができて、ログイン後にダッシュボードで自分の利用状況を見られる小規模 Web アプリを作りたい。登録完了時と重要な変更時には通知メールを送りたい。運営者向けには全ユーザーの利用状況を集計したレポート画面もほしい。 --repo-root /Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260728-082322-wt-11/eval-log/dev-graph/live-trial-fixtures/lp36-merge-none"})
...
`/Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260728-082322-wt-11/eval-log/dev-graph/live-trial-fixtures/lp36-merge-none/eval-log/macro-preview.json`

preview graph を C11 検証するときは、管理対象 repo へ一時ファイルを書かず **stdin 経路**を
使ってください (observation 5 の後半)。

```bash
python3 /Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260728-082322-wt-11/plugins/dev-graph/scripts/validate-graph-schema.py --graph - --repo-root /Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260728-082322-wt-11/eval-log/dev-graph/live-trial-fixtures/lp36-merge-none < /Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260728-082322-wt-11/eval-log/dev-graph/live-trial-fixtures/lp36-merge-none/eval-log/macro-preview.json
```
...
python3 /Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260728-082322-wt-11/plugins/dev-graph/tests/fixtures/audit_decompose_live_trial.py audit \
  --repo-root /Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260728-082322-wt-11/eval-log/dev-graph/live-trial-fixtures/lp36-merge-none \
  --preview /Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260728-082322-wt-11/eval-log/dev-graph/live-trial-fixtures/lp36-merge-none/eval-log/macro-preview.json \
  ...
  --pre-state /Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260728-082322-wt-11/eval-log/dev-graph/live-trial-fixtures/lp36-merge-none/eval-log/pre-state.json \
  --plugin-dir /Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260728-082322-wt-11/plugins/dev-graph \
  --run-mode apply \
  --run-binding none \
  --output /Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260728-082322-wt-11/eval-log/dev-graph/live-trial-fixtures/lp36-merge-none/eval-log/decompose-audit.json
```
...
一致するかを fixture の git 差分 (`git -C /Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260728-082322-wt-11/eval-log/dev-graph/live-trial-fixtures/lp36-merge-none status --short`) からも確認してください。
...
`/Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260728-082322-wt-11/eval-log/dev-graph/run-dev-graph-decompose/live-trial/20260729T050101Z-lp36-merge-none/out/status.json`
