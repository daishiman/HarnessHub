...
```
/Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260726-011205-wt-2/eval-log/dev-graph/run-dev-graph-decompose/live-trial/20260728T000712Z-mfh7-current/out/status.json
```
...
`/Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260726-011205-wt-2/eval-log/dev-graph/live-trial-fixtures/decompose-mfh7-current`
...
python3 /Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260726-011205-wt-2/plugins/dev-graph/tests/fixtures/audit_decompose_live_trial.py snapshot \
  --repo-root /Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260726-011205-wt-2/eval-log/dev-graph/live-trial-fixtures/decompose-mfh7-current \
  --output /Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260726-011205-wt-2/eval-log/dev-graph/live-trial-fixtures/decompose-mfh7-current/eval-log/pre-state.json
```
...
Skill({skill: "dev-graph:run-dev-graph-decompose", args: "--repo-root /Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260726-011205-wt-2/eval-log/dev-graph/live-trial-fixtures/decompose-mfh7-current --binding none --dry-run"})

Skill が入力 want から生成した feature / architecture / depends_on の preview graph を
一度だけ次へ保存してください。別の graph や期待 node は手書きしないでください。

`/Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260726-011205-wt-2/eval-log/dev-graph/live-trial-fixtures/decompose-mfh7-current/eval-log/macro-preview.json`
...
### evaluated_digest の正準レシピ (今回の追加要件)
...
という schema の意図を満たしません (HarnessHub-ojh6 残課題 #2)。監査は同じ手順で
再計算して突き合わせます。
...
python3 - <<'EOF'
import hashlib, json
p = "/Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260726-011205-wt-2/eval-log/dev-graph/live-trial-fixtures/decompose-mfh7-current/eval-log/macro-preview.json"
...
として存在できません**。過去の契約はこれを要求していたため充足不能でした
(HarnessHub-ojh6)。**この状態を作ろうとしないでください。**必ず上記 1 の完全昇格に
してください。
...
python3 /Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260726-011205-wt-2/plugins/dev-graph/tests/fixtures/audit_decompose_live_trial.py audit \
  --repo-root /Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260726-011205-wt-2/eval-log/dev-graph/live-trial-fixtures/decompose-mfh7-current \
  --preview /Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260726-011205-wt-2/eval-log/dev-graph/live-trial-fixtures/decompose-mfh7-current/eval-log/macro-preview.json \
  ...
  --pre-state /Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260726-011205-wt-2/eval-log/dev-graph/live-trial-fixtures/decompose-mfh7-current/eval-log/pre-state.json \
  --plugin-dir /Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260726-011205-wt-2/plugins/dev-graph \
  --output /Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260726-011205-wt-2/eval-log/dev-graph/live-trial-fixtures/decompose-mfh7-current/eval-log/decompose-audit.json
```
...
```bash
ls -1 /Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260726-011205-wt-2/eval-log/dev-graph/run-dev-graph-decompose/live-trial/20260728T000712Z-mfh7-current/out/
```
