...
1. `/Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260720-203525-wt-6/eval-log/dev-graph/run-dev-graph-decompose/live-trial/20260721T143217/out/status.json` だけに `{"status":"PASS|FAIL|ERROR","scenario":"decompose-macro-positive"}` をWriteする。
