...
```
/Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260726-011205-wt-2/eval-log/dev-graph/run-dev-graph-decompose/live-trial/20260727T212131Z-mfh7-decompose-bind/out/status.json
```
...
```bash
ls -1 /Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260726-011205-wt-2/eval-log/dev-graph/run-dev-graph-decompose/live-trial/20260727T212131Z-mfh7-decompose-bind/out/
```
