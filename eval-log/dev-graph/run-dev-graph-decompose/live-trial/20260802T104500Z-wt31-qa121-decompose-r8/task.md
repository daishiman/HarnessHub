# C14 live trial qa-131 r8 — latest-main deterministic replay, paired beads/none, no nudge

scenario `C14-OUT1-positive-macro-decomposition-r8` を現行 behavior closure で実走する。
...
- run workdir: `/Users/dm/orca/workspaces/HarnessHub/wt-31/eval-log/dev-graph/run-dev-graph-decompose/live-trial/20260802T104500Z-wt31-qa121-decompose-r8`
- beads fixture: `/Users/dm/orca/workspaces/HarnessHub/wt-31/eval-log/dev-graph/live-trial-fixtures/wt31-qa121-decompose-beads-r8`
- none fixture: `/Users/dm/orca/workspaces/HarnessHub/wt-31/eval-log/dev-graph/live-trial-fixtures/wt31-qa121-decompose-none-r8`
...
現在の r8 run workdir、r8 replay bundle、r8 beads/none fixture に対する読み取り専用の
存在・初期状態確認は step 1 の preflight に含めてよい。過去の live-trial run、過去
transcript、r8 以外の fixture は調査・参照してはならない。
...
`/Users/dm/orca/workspaces/HarnessHub/wt-31/eval-log/dev-graph/run-dev-graph-decompose/live-trial/20260802T104500Z-wt31-qa121-decompose-r8/out/status.json`

```json
{"status":"PASS","scenario":"C14-OUT1-positive-macro-decomposition-r8","binding":"paired:beads+none"}
```
