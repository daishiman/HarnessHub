...
`/Users/dm/orca/workspaces/HarnessHub/wt-26/eval-log/dev-graph/live-trial-fixtures/pr601-decompose-none-r2-091448`
...
python3 /Users/dm/orca/workspaces/HarnessHub/wt-26/plugins/dev-graph/tests/fixtures/audit_decompose_live_trial.py snapshot \
  --repo-root /Users/dm/orca/workspaces/HarnessHub/wt-26/eval-log/dev-graph/live-trial-fixtures/pr601-decompose-none-r2-091448 \
  --output /Users/dm/orca/workspaces/HarnessHub/wt-26/eval-log/dev-graph/live-trial-fixtures/pr601-decompose-none-r2-091448/eval-log/pre-state.json
```
...
Skill({skill: "dev-graph:run-dev-graph-decompose", args: "ユーザー登録とログインができて、ログイン後にダッシュボードで自分の利用状況を見られる小規模 Web アプリを作りたい。登録完了時と重要な変更時には通知メールを送りたい。運営者向けには全ユーザーの利用状況を集計したレポート画面もほしい。 --repo-root /Users/dm/orca/workspaces/HarnessHub/wt-26/eval-log/dev-graph/live-trial-fixtures/pr601-decompose-none-r2-091448"})
...
`/Users/dm/orca/workspaces/HarnessHub/wt-26/eval-log/dev-graph/live-trial-fixtures/pr601-decompose-none-r2-091448/eval-log/macro-preview.json`

preview graph を C11 検証するときは、管理対象 repo へ一時ファイルを書かず **stdin 経路**を
使ってください (observation 5 の後半)。

```bash
python3 /Users/dm/orca/workspaces/HarnessHub/wt-26/plugins/dev-graph/scripts/validate-graph-schema.py --graph - --repo-root /Users/dm/orca/workspaces/HarnessHub/wt-26/eval-log/dev-graph/live-trial-fixtures/pr601-decompose-none-r2-091448 < /Users/dm/orca/workspaces/HarnessHub/wt-26/eval-log/dev-graph/live-trial-fixtures/pr601-decompose-none-r2-091448/eval-log/macro-preview.json
```
...
python3 /Users/dm/orca/workspaces/HarnessHub/wt-26/plugins/dev-graph/tests/fixtures/audit_decompose_live_trial.py audit \
  --repo-root /Users/dm/orca/workspaces/HarnessHub/wt-26/eval-log/dev-graph/live-trial-fixtures/pr601-decompose-none-r2-091448 \
  --preview /Users/dm/orca/workspaces/HarnessHub/wt-26/eval-log/dev-graph/live-trial-fixtures/pr601-decompose-none-r2-091448/eval-log/macro-preview.json \
  --scenario /Users/dm/orca/workspaces/HarnessHub/wt-26/plugins/dev-graph/tests/fixtures/live-trial-positive-scenarios.json \
  --pre-state /Users/dm/orca/workspaces/HarnessHub/wt-26/eval-log/dev-graph/live-trial-fixtures/pr601-decompose-none-r2-091448/eval-log/pre-state.json \
  --plugin-dir /Users/dm/orca/workspaces/HarnessHub/wt-26/plugins/dev-graph \
  --run-mode apply \
  --run-binding none \
  --output /Users/dm/orca/workspaces/HarnessHub/wt-26/eval-log/dev-graph/live-trial-fixtures/pr601-decompose-none-r2-091448/eval-log/decompose-audit.json
```
...
一致するかを fixture の git 差分 (`git -C /Users/dm/orca/workspaces/HarnessHub/wt-26/eval-log/dev-graph/live-trial-fixtures/pr601-decompose-none-r2-091448 status --short`) からも確認してください。
...
`/Users/dm/orca/workspaces/HarnessHub/wt-26/eval-log/dev-graph/run-dev-graph-decompose/live-trial/20260729T091448Z-pr601-decompose-none-r2/out/status.json`
