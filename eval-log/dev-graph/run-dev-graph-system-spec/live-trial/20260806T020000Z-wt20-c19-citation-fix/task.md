...
```
Skill({skill: "dev-graph:run-dev-graph-system-spec", args: "--repo-root /Users/dm/orca/workspaces/HarnessHub/wt-20/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260803T115000Z-wt20-c19-citation-fix/fixture-repo"})
```
...
FIXTURE = `/Users/dm/orca/workspaces/HarnessHub/wt-20/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260803T115000Z-wt20-c19-citation-fix/fixture-repo`
...
```
/Users/dm/orca/workspaces/HarnessHub/wt-20/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260803T115000Z-wt20-c19-citation-fix/out/status.json
```
