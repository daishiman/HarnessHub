...
```
Skill({skill: "dev-graph:run-dev-graph-system-spec", args: "--repo-root /Users/dm/orca/workspaces/HarnessHub/wt-27-2/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260808T140907-c19specr2/fixture-repo"})
```
...
FIXTURE = `/Users/dm/orca/workspaces/HarnessHub/wt-27-2/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260808T140907-c19specr2/fixture-repo`
...
本 fixture では成立しません。writer が frontmatter 不足や見出し不足を理由に登録を拒否した場合は、
skill の正規手順の範囲内で不足を満たしたうえで再度 C02 経由で登録し直し、拒否理由と最終結果を
実測値でそのまま報告してください (拒否されたまま放置して「登録 0 件」で終わらせないこと)。
...
```
/Users/dm/orca/workspaces/HarnessHub/wt-27-2/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260808T140907-c19specr2/out/status.json
```
