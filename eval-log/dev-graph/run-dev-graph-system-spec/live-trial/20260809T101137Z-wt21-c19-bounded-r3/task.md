...
被験 fixture は `/Users/dm/orca/workspaces/HarnessHub/wt-21-2/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260809T101137Z-wt21-c19-bounded-r3/fixture-repo` にある dev-graph 初期化済みの独立 Git repository です。
...
```
Skill({skill: "dev-graph:run-dev-graph-system-spec", args: "--repo-root /Users/dm/orca/workspaces/HarnessHub/wt-21-2/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260809T101137Z-wt21-c19-bounded-r3/fixture-repo --resume"})
```
...
```
python3 /Users/dm/orca/workspaces/HarnessHub/wt-21-2/plugins/dev-graph/scripts/run-system-spec-resume-import.py --repo-root /Users/dm/orca/workspaces/HarnessHub/wt-21-2/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260809T101137Z-wt21-c19-bounded-r3/fixture-repo
```
...
`/Users/dm/orca/workspaces/HarnessHub/wt-21-2/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260809T101137Z-wt21-c19-bounded-r3/out/status.json`
