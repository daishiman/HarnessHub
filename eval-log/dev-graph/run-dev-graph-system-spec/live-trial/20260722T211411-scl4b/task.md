...
1. `/Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260722-093537-wt-11/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260722T211411-scl4b/out/status.json` に完了マーカーを 1 ファイルだけ Write する。内容:
