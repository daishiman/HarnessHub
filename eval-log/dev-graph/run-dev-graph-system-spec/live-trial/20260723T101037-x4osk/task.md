...
1. `/Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260722-163434-wt-8/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260723T101037-x4osk/out/status.json` に完了マーカーを 1 ファイルだけ Write する。内容:
