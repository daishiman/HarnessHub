...
被験 fixture は `/Users/dm/orca/workspaces/HarnessHub/wt-3/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260811T074916Z-wt3-c19-pr699/fixture-repo` にある dev-graph 初期化済みの独立 Git repository です。
...
```
Skill({skill: "dev-graph:run-dev-graph-system-spec", args: "--repo-root /Users/dm/orca/workspaces/HarnessHub/wt-3/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260811T074916Z-wt3-c19-pr699/fixture-repo --resume"})
```
...
```
python3 /Users/dm/orca/workspaces/HarnessHub/wt-3/plugins/dev-graph/scripts/build-system-spec-resume-import.py --repo-root /Users/dm/orca/workspaces/HarnessHub/wt-3/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260811T074916Z-wt3-c19-pr699/fixture-repo
```
...
`/Users/dm/orca/workspaces/HarnessHub/wt-3/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260811T074916Z-wt3-c19-pr699/out/status.json`
