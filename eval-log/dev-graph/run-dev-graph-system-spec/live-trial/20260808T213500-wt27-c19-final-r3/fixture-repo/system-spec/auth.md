...
**質問**: 書面入力 system-spec/requirements-brief.md の section 「§3 カテゴリ別の確定回答 (web 列) / category=auth」で、カテゴリ auth × platform web の確定内容は何か

**回答**: | auth | 単一利用者向けの bearer token 認証。token は初回起動時にローカル生成し、ハッシュ化して保存する。全 TODO エンドポイントで必須、未認証は 401。OWASP ASVS の認証秘密保護原則を適用し、平文 token を永続化しない。 | G2 |
...
|---|---|---|---|---|---|
| local-bearer-token | 0.141.1 | FastAPI (tiangolo) (fastapi.tiangolo.com) | https://fastapi.tiangolo.com/tutorial/security/ | 2026-08-08T12:42:18Z | 2026-08-08T12:42:18Z |
| oauth2-password-jwt | RFC 6749 | IETF (Internet Engineering Task Force) (datatracker.ietf.org) | https://datatracker.ietf.org/doc/html/rfc6749 | 2026-08-08T12:42:19Z | 2026-08-08T12:42:19Z |
