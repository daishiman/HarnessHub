...
被験 fixture は `/Users/dm/orca/workspaces/HarnessHub/wt-18-3/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260809T212925Z-wt18-c19-bounded-r2/fixture-repo` にある dev-graph 初期化済みの独立 Git repository です。
...
```
Skill({skill: "dev-graph:run-dev-graph-system-spec", args: "--repo-root /Users/dm/orca/workspaces/HarnessHub/wt-18-3/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260809T212925Z-wt18-c19-bounded-r2/fixture-repo --resume"})
```
...
```
python3 /Users/dm/orca/workspaces/HarnessHub/wt-18-3/plugins/dev-graph/scripts/build-system-spec-resume-import.py --repo-root /Users/dm/orca/workspaces/HarnessHub/wt-18-3/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260809T212925Z-wt18-c19-bounded-r2/fixture-repo
```
...
`/Users/dm/orca/workspaces/HarnessHub/wt-18-3/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260809T212925Z-wt18-c19-bounded-r2/out/status.json`
