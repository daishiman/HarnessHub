...
**質問**: 書面入力 system-spec/requirements-brief.md の section 「## 3. カテゴリ別の確定回答 (web 列)」 の category=backend 行が示す web platform の確定内容は何か
...
|---|---|---|---|---|---|
| fastapi | 0.141.1 | Sebastián Ramírez (tiangolo) / FastAPI (fastapi.tiangolo.com) | https://fastapi.tiangolo.com/release-notes/ | 2026-08-08T14:18:31Z | 2026-08-08T14:18:31Z |
