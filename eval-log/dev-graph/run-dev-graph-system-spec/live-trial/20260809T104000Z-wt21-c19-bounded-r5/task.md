# タスク: bounded C19 live trial

<!-- live-trial-premise:begin scenario=C19-OUT1-positive-system-spec-lineage-r3-bounded contract-digest=50e62835ca3c5664 -->

## この scenario の入力前提 (fixture 正本から生成。手で書き換えないこと)

被験 fixture は `/Users/dm/orca/workspaces/HarnessHub/wt-21-2/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260809T104000Z-wt21-c19-bounded-r5/fixture-repo` にある dev-graph 初期化済みの独立 Git repository です。

fixture が最初から置く業務入力は次の 4 ファイルだけです:
...
```
Skill({skill: "dev-graph:run-dev-graph-system-spec", args: "--repo-root /Users/dm/orca/workspaces/HarnessHub/wt-21-2/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260809T104000Z-wt21-c19-bounded-r5/fixture-repo --resume"})
```
...
```
python3 /Users/dm/orca/workspaces/HarnessHub/wt-21-2/plugins/dev-graph/scripts/build-system-spec-resume-import.py --repo-root /Users/dm/orca/workspaces/HarnessHub/wt-21-2/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260809T104000Z-wt21-c19-bounded-r5/fixture-repo
```
...
`/Users/dm/orca/workspaces/HarnessHub/wt-21-2/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260809T104000Z-wt21-c19-bounded-r5/out/status.json`
