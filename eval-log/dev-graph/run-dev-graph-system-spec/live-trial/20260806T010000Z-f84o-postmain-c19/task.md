...
```
Skill({skill: "dev-graph:run-dev-graph-system-spec", args: "--repo-root /Users/dm/orca/workspaces/HarnessHub/wt-29-2/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260806T010000Z-f84o-postmain-c19/fixture-repo"})
```
...
FIXTURE = `/Users/dm/orca/workspaces/HarnessHub/wt-29-2/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260806T010000Z-f84o-postmain-c19/fixture-repo`
...
```
/Users/dm/orca/workspaces/HarnessHub/wt-29-2/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260806T010000Z-f84o-postmain-c19/out/status.json
```
