...
**最終必須処理:** 全検証後、最終返答より前に必ず `/Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260721-224927-wt-8/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260722T122106-e9b-r4/out/status.json` へ `{"status":"PASS|FAIL|ERROR","scenario":"system-spec-positive-lineage"}` をWriteし、`DONE: <status>` と1行だけ報告すること。out/にこれ以外を書かない。
...
Skill({skill: "dev-graph:run-dev-graph-system-spec", args: "--repo-root /Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260721-224927-wt-8/eval-log/dev-graph/live-trial-fixtures/20260722T122106-e9b-r4-fixture"})
