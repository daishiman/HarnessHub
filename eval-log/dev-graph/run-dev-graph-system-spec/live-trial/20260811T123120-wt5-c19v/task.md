...
```
Skill({skill: "dev-graph:run-dev-graph-system-spec", args: "--repo-root /Users/dm/orca/workspaces/HarnessHub/wt-5/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260811T123120-wt5-c19v/fixture-repo --resume"})
```
...
```
python3 /Users/dm/orca/workspaces/HarnessHub/wt-5/plugins/dev-graph/scripts/build-system-spec-resume-import.py --repo-root /Users/dm/orca/workspaces/HarnessHub/wt-5/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260811T123120-wt5-c19v/fixture-repo
```
...
`/Users/dm/orca/workspaces/HarnessHub/wt-5/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260811T123120-wt5-c19v/out/status.json`
