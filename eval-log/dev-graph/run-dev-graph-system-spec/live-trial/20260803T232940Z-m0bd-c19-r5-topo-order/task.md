...
```
Skill({skill: "dev-graph:run-dev-graph-system-spec", args: "--repo-root /Users/dm/orca/workspaces/HarnessHub/wt-21/eval-log/dev-graph/live-trial-fixtures/m0bd-c19-r5-topo-order-20260803"})
```
...
被験 fixture は `/Users/dm/orca/workspaces/HarnessHub/wt-21/eval-log/dev-graph/live-trial-fixtures/m0bd-c19-r5-topo-order-20260803` にある dev-graph 初期化済みの独立 Git repository です。
...
完了時は `/Users/dm/orca/workspaces/HarnessHub/wt-21/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260803T232940Z-m0bd-c19-r5-topo-order/out/status.json` だけへ `{"status":"PASS|FAIL|ERROR","scenario":"C19-OUT1-positive-system-spec-lineage-r2"}` を書く。最後は `DONE: <status>` の1行だけで報告する。
