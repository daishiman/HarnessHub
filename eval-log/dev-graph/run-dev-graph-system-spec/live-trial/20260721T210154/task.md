...
Skill({skill: "dev-graph:run-dev-graph-system-spec", args: "--repo-root /Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260720-203654-wt-8/eval-log/dev-graph/live-trial-fixtures/r3-system-spec-r2"})
...
1. `/Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260720-203654-wt-8/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260721T210154/out/status.json` だけに `{"status":"PASS|FAIL|ERROR","scenario":"system-spec-positive-lineage"}` をWriteする。
