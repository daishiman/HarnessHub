...
Skill({skill: "dev-graph:run-dev-graph-system-spec", args: "--repo-root /Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260721-224927-wt-8/eval-log/dev-graph/live-trial-fixtures/r3-system-spec-e9b-r2"})
...
- **完成度評価 (assign-system-spec-completeness-evaluator) は skill 本文の手順どおり独立 auditor を Task fork して判定を得ること。** `audit_delegations[]` は PostToolUse hook の正規 fork 台帳で裏取りできる内容にし、fixture 内への台帳の手作成・複製や completeness-report.json の手作成による代替を禁止する。

処理が終了 (成功 / 失敗 / 中断いずれでも) したら:

1. `/Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260721-224927-wt-8/eval-log/dev-graph/run-dev-graph-system-spec/live-trial/20260721T210941-e9b-r2/out/status.json` だけに `{"status":"PASS|FAIL|ERROR","scenario":"system-spec-positive-lineage"}` をWriteする。
