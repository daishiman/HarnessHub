...
FIXTURE = `/private/tmp/claude-501/-Users-dm-orca-workspaces-HarnessHub-issue---/d644473e-e080-4321-9a75-e5ff62feb1dd/scratchpad/lt/20260815T015641Z-mx65-c03/fixture-repo`
...
**最重要の計測契約:** Skill tool は手順をロードするだけで、1回の呼出しを3パス分に数えてはいけません。パス1の Bash 作業が終わった直後、apply の Bash を1つでも実行する前に2回目の literal Skill tool_use を行ってください。apply 終了直後、確認 dry-run の Bash より前に3回目の literal Skill tool_use を行ってください。transcript 上の Skill tool_use が正確に3回でなければ、同期結果が正しくても FAIL です。
...
Skill({skill: "dev-graph:run-dev-graph-sync", args: "--repo-root /private/tmp/claude-501/-Users-dm-orca-workspaces-HarnessHub-issue---/d644473e-e080-4321-9a75-e5ff62feb1dd/scratchpad/lt/20260815T015641Z-mx65-c03/fixture-repo --dry-run"})

パス 2 (適用):

Skill({skill: "dev-graph:run-dev-graph-sync", args: "--repo-root /private/tmp/claude-501/-Users-dm-orca-workspaces-HarnessHub-issue---/d644473e-e080-4321-9a75-e5ff62feb1dd/scratchpad/lt/20260815T015641Z-mx65-c03/fixture-repo --apply"})
...
全検証後、
`/private/tmp/claude-501/-Users-dm-orca-workspaces-HarnessHub-issue---/d644473e-e080-4321-9a75-e5ff62feb1dd/scratchpad/lt/20260815T015641Z-mx65-c03/out/status.json`
