...
1. `/Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260725-071755-wt-4/eval-log/dev-graph/run-dev-graph-sync/live-trial/20260725T004437Z-i07-sync/out/status.json` に完了マーカーを 1 ファイルだけ Write する。内容:
