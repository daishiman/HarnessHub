...
FIXTURE = `/private/tmp/harnesshub-o4zi.Gv5hFK/eval-log/dev-graph/run-dev-graph-sync/live-trial/20260808T131000Z-o4zi-exh-c03r2/fixture-repo`
...
Skill({skill: "dev-graph:run-dev-graph-sync", args: "--repo-root /private/tmp/harnesshub-o4zi.Gv5hFK/eval-log/dev-graph/run-dev-graph-sync/live-trial/20260808T131000Z-o4zi-exh-c03r2/fixture-repo --dry-run"})

パス 2 (適用):

Skill({skill: "dev-graph:run-dev-graph-sync", args: "--repo-root /private/tmp/harnesshub-o4zi.Gv5hFK/eval-log/dev-graph/run-dev-graph-sync/live-trial/20260808T131000Z-o4zi-exh-c03r2/fixture-repo --apply"})
...
全検証後、
`/private/tmp/harnesshub-o4zi.Gv5hFK/eval-log/dev-graph/run-dev-graph-sync/live-trial/20260808T131000Z-o4zi-exh-c03r2/out/status.json`
