...
FIXTURE = `/private/tmp/harnesshub-o4zi.Gv5hFK/eval-log/dev-graph/run-dev-graph-status/live-trial/20260808T125000Z-o4zi-exh-c18/fixture-repo`
...
Skill({skill: "dev-graph:run-dev-graph-status", args: "--repo-root /private/tmp/harnesshub-o4zi.Gv5hFK/eval-log/dev-graph/run-dev-graph-status/live-trial/20260808T125000Z-o4zi-exh-c18/fixture-repo"})
...
全検証後、
`/private/tmp/harnesshub-o4zi.Gv5hFK/eval-log/dev-graph/run-dev-graph-status/live-trial/20260808T125000Z-o4zi-exh-c18/out/status.json`
