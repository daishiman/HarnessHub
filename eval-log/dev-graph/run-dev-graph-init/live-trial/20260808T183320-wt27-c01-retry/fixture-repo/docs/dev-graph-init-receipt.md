---
graph_node_id: "doc-dev-graph-init-receipt"
artifact_kind: "document"
artifact_subtypes: []
layer: "operations"
project_id: "fixture-repo"
domain: "dev-graph"
tags: ["dev-graph","init","receipt","live-trial"]
priority: null
start_date: null
target_date: null
iteration: null
title: "dev-graph 初期化受領書"
owners: ["harness maintainers"]
created_at: "2026-08-08T10:05:30.481126Z"
updated_at: "2026-08-08T10:05:30.481126Z"
status: "draft"
depends_on: []
related_nodes: []
resource_scope: ["docs/dev-graph-init-receipt.md"]
purpose: null
goal: null
scope_in: []
scope_out: []
...
phase_ref: null
file_path: "docs/dev-graph-init-receipt.md"
...
classification_reason: "C01 init live-trial の実行結果を記録する運用文書で、仕様・設計判断・実行課題のいずれでもない。summary が初期化記録である旨を明示し、本文構成が document template の目的/対象読者/要約/本文/決定事項/運用・更新方法/関連資料/変更履歴に一致するため document と判定した (kind は呼出し引数でも document を明示指定)。"
classification_candidates: [{"artifact_kind":"document","candidate_path":"docs/dev-graph-init-receipt.md","confidence":0.93},{"artifact_kind":"specification","candidate_path":"specs/dev-graph-init-receipt.md","confidence":0.04},{"artifact_kind":"task","candidate_path":"tasks/dev-graph-init-receipt.md","confidence":0.02}]
issue_linkage: null
...
implementation_readiness: {"checked_at":null,"missing_sections":[],"status":"not_applicable"}
---
