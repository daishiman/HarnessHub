...
FIXTURE = `/private/tmp/harnesshub-o4zi.Gv5hFK/eval-log/dev-graph/run-dev-graph-requirements/live-trial/20260808T123500Z-o4zi-exh-c04/fixture-repo`
...
Skill({skill: "dev-graph:run-dev-graph-requirements", args: "--repo-root /private/tmp/harnesshub-o4zi.Gv5hFK/eval-log/dev-graph/run-dev-graph-requirements/live-trial/20260808T123500Z-o4zi-exh-c04/fixture-repo --feature-id F-LIVE-001"})
...
全検証後、
`/private/tmp/harnesshub-o4zi.Gv5hFK/eval-log/dev-graph/run-dev-graph-requirements/live-trial/20260808T123500Z-o4zi-exh-c04/out/status.json`
