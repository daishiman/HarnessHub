---
graph_node_id: "SYS-LIVE-001-P06"
artifact_kind: "task"
artifact_subtypes: []
title: "テスト実行 (P06)"
...
related_nodes: []
resource_scope: []
purpose: "テスト実行を実行する exact-13 package の 1 phase"
goal: "テスト実行が完了し後続 phase が着手できる状態"
scope_in: ["テスト実行の実行"]
scope_out: ["他 feature の task への直接介入"]
acceptance: ["テスト実行の成果物が存在する"]
architecture_refs: []
parent_feature: "F-LIVE-001"
feature_package_id: "feature-package/F-LIVE-001"
phase_ref: "P06"
file_path: "tasks/F-LIVE-001/sys-live-001-p06.md"
template_id: "task"
...
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/F-LIVE-001/sys-live-001-p06.md", "confidence": 1.0}]
issue_linkage: null
