---
graph_node_id: "SYS-LIVE-001-P03"
artifact_kind: "task"
artifact_subtypes: []
title: "独立設計レビュー (P03)"
...
depends_on: ["SYS-LIVE-001-P02"]
related_nodes: []
resource_scope: []
purpose: "独立設計レビューを実行する exact-13 package の 1 phase"
goal: "独立設計レビューが完了し後続 phase が着手できる状態"
scope_in: ["独立設計レビューの実行"]
scope_out: ["他 feature の task への直接介入"]
acceptance: ["独立設計レビューの成果物が存在する"]
architecture_refs: []
parent_feature: "F-LIVE-001"
feature_package_id: "feature-package/F-LIVE-001"
phase_ref: "P03"
file_path: "tasks/F-LIVE-001/sys-live-001-p03.md"
template_id: "task"
...
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/F-LIVE-001/sys-live-001-p03.md", "confidence": 1.0}]
issue_linkage: null
