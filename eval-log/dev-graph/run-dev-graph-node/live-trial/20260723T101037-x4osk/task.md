...
1. `/Users/dm/dev/dev/個人開発/HarnessHub/.worktrees/task-20260722-163434-wt-8/eval-log/dev-graph/run-dev-graph-node/live-trial/20260723T101037-x4osk/out/status.json` だけに `{"status":"PASS|FAIL|ERROR","scenario":"node-five-artifact-positive"}` をWriteする。
