...
- 対象 fixture repository は `/Users/dm/orca/workspaces/HarnessHub/wt-27-2/eval-log/dev-graph/run-dev-graph-node/live-trial/20260808T120142-c02n1/fixture-repo` (dev-graph 初期化済み。`.dev-graph/config.json`、空の `.dev-graph/state/graph.json` (graph_revision=0, nodes=[])、6 つの content root を持つ)。
...
- 検証: `python3 /Users/dm/orca/workspaces/HarnessHub/wt-27-2/plugins/dev-graph/scripts/validate-graph-schema.py` を fixture repository の graph store に対して実行し、PASS することを確認する。あわせて fixture repository の `features/` 配下に C14 macro-feature 契約外のノードが生成されていないことを確認する。

以下を実行してください:

Skill({skill: "dev-graph:run-dev-graph-node", args: "add --repo-root /Users/dm/orca/workspaces/HarnessHub/wt-27-2/eval-log/dev-graph/run-dev-graph-node/live-trial/20260808T120142-c02n1/fixture-repo --input /Users/dm/orca/workspaces/HarnessHub/wt-27-2/eval-log/dev-graph/run-dev-graph-node/live-trial/20260808T120142-c02n1/fixture-repo/mixed-artifacts.json"})

処理が終了 (成功 / 失敗 / 中断いずれでも) したら:

1. /Users/dm/orca/workspaces/HarnessHub/wt-27-2/eval-log/dev-graph/run-dev-graph-node/live-trial/20260808T120142-c02n1/out/status.json に完了マーカーを 1 ファイルだけ Write する。内容:
