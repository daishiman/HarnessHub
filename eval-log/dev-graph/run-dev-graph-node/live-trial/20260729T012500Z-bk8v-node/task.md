...
`/Users/dm/orca/workspaces/HarnessHub/wt-26/eval-log/dev-graph/live-trial-fixtures/bk8v-node`

管理対象 graph/config/content root を手で直接編集してはいけません。

以下を実行してください:

Skill({skill: "dev-graph:run-dev-graph-node", args: "add --repo-root /Users/dm/orca/workspaces/HarnessHub/wt-26/eval-log/dev-graph/live-trial-fixtures/bk8v-node --input /Users/dm/orca/workspaces/HarnessHub/wt-26/eval-log/dev-graph/live-trial-fixtures/bk8v-node/mixed-artifacts.json"})
...
1. `/Users/dm/orca/workspaces/HarnessHub/wt-26/eval-log/dev-graph/run-dev-graph-node/live-trial/20260729T012500Z-bk8v-node/out/status.json`
