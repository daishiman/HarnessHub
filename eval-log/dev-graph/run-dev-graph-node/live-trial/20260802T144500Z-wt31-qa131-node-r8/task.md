# タスク: dev-graph:run-dev-graph-node の最終再実走 r8 (scenario C02-OUT1-positive-mixed-artifacts)
...
Skill({skill: "dev-graph:run-dev-graph-node", args: "add --repo-root /Users/dm/orca/workspaces/HarnessHub/wt-31/eval-log/dev-graph/live-trial-fixtures/wt31-qa131-node-r8 --input /Users/dm/orca/workspaces/HarnessHub/wt-31/eval-log/dev-graph/live-trial-fixtures/wt31-qa131-node-r8/mixed-artifacts.json"})
...
1. `/Users/dm/orca/workspaces/HarnessHub/wt-31/eval-log/dev-graph/run-dev-graph-node/live-trial/20260802T144500Z-wt31-qa131-node-r8/out/status.json` に完了マーカーを 1 ファイルだけ Write する。内容:
