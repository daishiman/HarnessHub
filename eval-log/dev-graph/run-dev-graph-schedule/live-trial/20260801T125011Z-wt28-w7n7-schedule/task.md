...
Skill({skill: "dev-graph:run-dev-graph-schedule", args: "--repo-root /Users/dm/orca/workspaces/HarnessHub/wt-28/eval-log/dev-graph/live-trial-fixtures/w7n7-schedule-20260801 --max-parallel 2"})
...
1. /Users/dm/orca/workspaces/HarnessHub/wt-28/eval-log/dev-graph/run-dev-graph-schedule/live-trial/20260801T125011Z-wt28-w7n7-schedule/out/status.json に完了マーカーを 1 ファイルだけ Write する。内容:
