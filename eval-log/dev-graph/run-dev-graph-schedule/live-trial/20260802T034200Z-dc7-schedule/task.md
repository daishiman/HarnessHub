...
Skill({skill: "dev-graph:run-dev-graph-schedule", args: "--repo-root /Users/dm/orca/workspaces/HarnessHub/wt-33/eval-log/dev-graph/live-trial-fixtures/dc7-schedule-20260802 --max-parallel 2"})
...
1. /Users/dm/orca/workspaces/HarnessHub/wt-33/eval-log/dev-graph/run-dev-graph-schedule/live-trial/20260802T034200Z-dc7-schedule/out/status.json に完了マーカーを 1 ファイルだけ Write する。内容:
