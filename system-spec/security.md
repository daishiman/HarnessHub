...
##### 確定内容 qa-161 (対応セル: web)

- 確定要件: C07 matrix-auditor の HIGH finding への確定対応。qa-152 / qa-158 の逐語は改変せず、本 entry を正本とする。私の以前の境界記述は『認可層は 1 つ』という誤った前提に立っており、実装は 2 段構えである。訂正する。
