...
| publish smoke の channel 解放順序、fixture lease と cancel 後回収 | `testing-qa.md` qa-217 の disposable cleanup / fail-closed 契約 | [production coverage smoke 追補](../specs/harness-hub-production-coverage-smoke-addendum.md) / [2026-08-11 受領書](../docs/features/feat-dual-catalog-web/mvp-ops-reliability-20260811-spec-reflection-receipt.md) | `feat-publish-pipeline` / `HarnessHub-pf5o`・`HarnessHub-aauo`（本番再実走・force-cancel 証跡まで open） |
