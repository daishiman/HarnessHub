...
| 配色仕様書 v2（グラファイト×アンバー、書体 3 種、md=640/lg=1024） | `frontend.md` / `ui-ux.md` の見た目契約。qa-226 の md=768 逐語は未 reopen | [UI 基盤追補](../specs/harness-hub-ui-foundation-addendum.md) FR-UIF-003/014 / [受領書](../docs/features/feat-hub-foundation/visual-system-v2-20260813-spec-reflection-receipt.md) | `feat-hub-foundation` / `HarnessHub-l0o6` |
