...
updated_at: "2026-08-02T09:01:42.637991Z"
status: "active"
depends_on: []
...
source_lineage: {"imported_at":"2026-08-02T09:01:07Z","origin_kind":"system-spec-harness","source_digest":"50cd1d223a33474217da9e4095b4db990907d7fa14de7fddd5afdad7b6abdf4c","source_path":"system-spec/spec-state.json","source_plugin":"system-spec-harness","source_version":"0.1.0"}
...
**CWV 実測境界 (2026-08-02 / `HarnessHub-9cgb` / qa-133):** 通常 session を CI に複製せず、固定 origin・tenant/workspace・catalog read だけへ 5 分で失効する probe credential を使う。詳細と外部未完了は [受領書](../docs/features/feat-hub-foundation/cwv-probe-credential-spec-reflection-receipt.md)、正本は `system-spec` の qa-133 を参照する。
