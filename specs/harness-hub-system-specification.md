...
- [system-spec/00-requirements-definition.md](../system-spec/00-requirements-definition.md) (sha256: `f5e022ed4ad5ae96…`)
- [system-spec/index.md](../system-spec/index.md) (sha256: `cb856fdae1ce0053…`)
...
- `qa-074`〜`qa-078` として auth / security / backend / database / infrastructure の web セルを R4 reopen →再確定した。
...
- 既存の completeness evaluator FAIL 是正 2 件は本変更の対象外で、現在の `system-spec/completeness-report.json` を正とする。
