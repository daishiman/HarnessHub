...
- Produced artifacts: apps/publisher/ (CLI core・auth・deploy・plugin 面), packages/schemas/publisher-plugin/ (Publisher 固有 zod スキーマ), docs/features/feat-publisher-plugin/implementation-notes.md
...
- Write scope/touches: apps/publisher/, packages/schemas/publisher-plugin/, docs/features/feat-publisher-plugin/implementation-notes.md
...
- Required evidence: apps/publisher/ に CLI core・auth・deploy・plugin 面が実装され、P04 の test-design.md に列挙された全テストケースに対応する実装対象が揃っていること
