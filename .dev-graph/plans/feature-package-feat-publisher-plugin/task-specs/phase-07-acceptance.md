...
- Consumed artifacts: docs/features/feat-publisher-plugin/test-run-results.md, .dev-graph/staging/feature-package-feat-publisher-plugin/goal-spec.json
...
- Required evidence: acceptance-record.md に acceptance 3 件それぞれの判定結果 (満たす/満たさない) と根拠 (test-run-results.md への参照) が記載されていること
