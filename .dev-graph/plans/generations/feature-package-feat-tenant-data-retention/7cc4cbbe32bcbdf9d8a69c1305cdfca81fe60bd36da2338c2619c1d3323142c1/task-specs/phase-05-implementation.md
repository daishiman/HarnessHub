...
- Produced artifacts: packages/db/src/schema/tenant-data-objects.ts, packages/schemas/tenant-data/, apps/hub/src/app/api/v1/tenant-data/, apps/hub/src/lib/tenant-data/, apps/hub/src/lib/scheduled/r2-usage-monitor.ts, docs/features/feat-tenant-data-retention/implementation-notes.md, packages/db/src/schema/encryption-keys.ts, packages/db/src/repository/tenant-deks.ts, packages/db/src/backup/tenant-data-tombstones.ts, apps/hub/src/lib/scheduled/usage-monitor.ts, packages/db/migrations/ (normative implementation artifacts)
...
- Write scope/touches: packages/db/src/schema/tenant-data-objects.ts, packages/schemas/tenant-data/, apps/hub/src/app/api/v1/tenant-data/, apps/hub/src/lib/tenant-data/, apps/hub/src/lib/scheduled/r2-usage-monitor.ts, docs/features/feat-tenant-data-retention/implementation-notes.md, packages/db/src/schema/encryption-keys.ts, packages/db/src/repository/tenant-deks.ts, packages/db/src/backup/tenant-data-tombstones.ts, apps/hub/src/lib/scheduled/usage-monitor.ts, packages/db/migrations/
...
- Required evidence: packages/db/src/schema/tenant-data-objects.ts, packages/schemas/tenant-data/, apps/hub/src/app/api/v1/tenant-data/, apps/hub/src/lib/tenant-data/, apps/hub/src/lib/scheduled/r2-usage-monitor.ts が実装され、P04 の test-design.md に列挙された全テストケースに対応する実装対象が揃っていること. Normative evidence: 2 tenantで別DEK/version、cross-tenant unwrap拒否、rotation、R2+DB+backup restore non-restoration、既存cron dispatch registration、70/90%通知をP04/P06/P09/P10/P11で実証する。
