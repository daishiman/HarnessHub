...
- Entry gate: sys-feedback-loop-p06 の test-run-report.md で 8 テストカテゴリ全件が pass していること。かつ goal-spec.json の feature_context_digest が sha256:072f4574b7156af35459d941d9c0655fe9f50453e151420d6e98fcb7da5499c3 に一致し、features/feat-feedback-loop.md の confirmation_status が confirmed であること
...
- Consumed artifacts: docs/features/feat-feedback-loop/test-run-report.md, goal-spec.json
