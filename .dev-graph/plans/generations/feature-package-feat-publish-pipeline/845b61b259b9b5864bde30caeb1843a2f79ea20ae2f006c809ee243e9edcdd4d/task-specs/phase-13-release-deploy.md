...
- Latest-main lineage pin: `specs/harness-hub-system-specification.md` = `sha256:62a5be5f96a84aa3ef2cd8878c2c6745d9386c93316f76a5d683f882737746a6`、`architecture/harness-hub-data.md` = `sha256:3fdf8c616692ab04f7eac5d188d915cb962978234f81a5de0d1cae152108a196`、`docs/backend-spec.md` = `sha256:15c47851da39c17354a2cd04f5d093b5bfeb6a07832881c2417091f5a06a0160` (`origin/main` `02947ebc7532c099da636a88f936874371b326f6`)。追加内容は libSQL 接続復旧と dev-graph renderer 登録検証であり、publish pipeline の scope/acceptance/API/認可契約は変更しない。
