...
description: Cloudflare Workers のコードを本番水準の指針に照らして書く、またはレビューする。ストリーミング、放置された Promise、グローバル状態、シークレット、binding、可観測性といった典型的な誤りと、wrangler.jsonc の設定を点検するときに使う。
---
