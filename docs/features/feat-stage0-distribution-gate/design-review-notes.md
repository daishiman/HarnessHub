...
[Windows 実機不在が各決定と完了条件へ与える影響の詳細](design-review-environment-evidence.md#4-windows-実機がこの環境に存在しないことの帰結)

## 5. 事実と推測の区分

[fact・inference・未検証事項の区分の詳細](design-review-environment-evidence.md#5-事実と推測の区分)
