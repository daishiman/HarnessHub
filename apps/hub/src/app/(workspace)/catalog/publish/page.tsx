...
export const metadata: Metadata = {
  title: 'ハーネスを公開する | Harness Hub',
  description: 'CLI を使わずに、Hub の Web 画面だけでハーネスを公開します。',
};
...
export default async function PublishWizardPage({ searchParams }: PageProps) {
  ...
  return (
    <>
      {/* 見出しは実際に公開できるものに合わせる。いま公開できるのはハーネス (ZIP で配布する
          プラグイン一式) だけで、「ツール」で始めると中の面で「ハーネスだけです」と断る読み順になる。
