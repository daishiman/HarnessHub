...
goal: "qa-076/qa-077/qa-079/qa-080/qa-089/qa-095/qa-119/qa-130/qa-132/qa-133 の確定内容と D8 に適合し、task 仕様書の品質ゲートを promotion 前後で再現可能にする設計指針を提供する"
...
confirmation_evidence: {"evaluated_digest":"b1dac50f4548b867f0c126cde30145a3ae6e08315a893ac6514ab7752735ea14","evaluator":"validate-coverage-matrix.py --require-complete","evidence_ref":"system-spec/spec-state.json"}
source_lineage: {"imported_at":"2026-08-02T10:39:21Z","origin_kind":"system-spec-harness","source_digest":"b1dac50f4548b867f0c126cde30145a3ae6e08315a893ac6514ab7752735ea14","source_path":"system-spec/testing-qa.md","source_plugin":"system-spec-harness","source_version":"0.1.0"}
...
- [system-spec/testing-qa.md](../system-spec/testing-qa.md) (sha256: `b1dac50f4548b867…` (完全値は frontmatter source_lineage.source_digest))
...
- **世代非依存 rerun command (qa-133)**: promotion 前は planner が実際の staging generation path を内部検証し、promotion 後の task spec は `--feature-package <self-package-id>` で current pointer から現行世代を解決する。contract 1.3.0 は `--staging`、flag 欠落、別 package id を fail-closed に拒否し、1.2.0 以前の immutable package は当時の契約で再検証する。
